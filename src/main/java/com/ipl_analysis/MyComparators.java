...
public class MyComparators {
	...
	Comparator<IplPlayer> strikeRateComparator = Comparator.comparing(iplBatsman -> iplBatsman.strikeRate,
			Comparator.reverseOrder());

	Comparator<IplPlayer> runsAverageComparator = Comparator.comparing(iplBatsman -> iplBatsman.avg,
			Comparator.reverseOrder());
	...
	Comparator<IplPlayer> avg = Comparator.comparing(iplBatsman -> iplBatsman.avg, Comparator.reverseOrder());
	Comparator<IplPlayer> avgWithStrikeRateComparator = avg.thenComparing(iplBatsman -> iplBatsman.strikeRate,
			Comparator.reverseOrder());

	Comparator<IplPlayer> runs = Comparator.comparing(iplBatsman -> iplBatsman.runsScored, Comparator.reverseOrder());
	Comparator<IplPlayer> runsThenAverageComparator = runs.thenComparing(iplBatsman -> iplBatsman.avg,
			Comparator.reverseOrder());

	Comparator<IplPlayer> bowlerAvgComparator = Comparator.comparing(iplBowler -> iplBowler.bowlingAvg,
			Comparator.reverseOrder());

	public static Map<Enum, Comparator<IplPlayer>> comparators = new HashMap<>();
	...
	public MyComparators() {
		...
		this.comparators.put(CompareBasedOn.BOWLING_AVG, this.bowlerAvgComparator);
	}
}
